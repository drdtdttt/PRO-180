...
$.ajax({
    ...
    `
        <a-entity gps-entity-palace="latitude: ${steps[i].manuver.location[1]}; longitude: ${steps[i].manuver.location[0]};">
           <a-entity>
            <a-text height="50" value="Weather foracast is ${weather} at${name}"></a-text>
           </a-entity>
        </a-entity>
    `  
       )
